      ...
      *** TOPBAR ***
      ...
      <nav class="navbar navbar-expand-lg">
        <div class="container"><a href="index.php" class="navbar-brand home"><!--<img src="img/.png" alt=" logo" class="d-none d-md-inline-block"><img src="img/logo-smal.png" alt=" logo" class="d-inline-block d-md-none">--><span class="sr-only">Kalu - go to homepage</span></a>
          <div class="navbar-buttons d-flex justify-content-start my-2">
            <button type="button" data-toggle="collapse" data-target="#navigation" id="toggleNav"
             class="btn btn-outline-secondary navbar-toggler"><span class="sr-only">Toggle navigation</span><i class="fa fa-align-justify"></i></button>
          ...
          <div id="navigation" class="collapse navbar-collapse">
            <ul class="navbar-nav mr-auto">
              ...
              <li class="nav-item dropdown menu-large "><a href="category-full.php?men" data-toggle="dropdown" data-hover="dropdown" data-delay="200" class="dropdown-toggle nav-link ml-lg-4">Men<b class="caret"></b></a>
              ...
              <li class="nav-item dropdown menu-large"><a href="category-full.php?ladies" data-toggle="dropdown" data-hover="dropdown" data-delay="200" class="dropdown-toggle nav-link ml-lg-4">Ladies<b class="caret"></b></a>
                <ul class="dropdown-menu megamenu">
                  <li>
                    <div class="row">
                      <div class="col-md-6 col-lg-3">
              ...
              <li class="nav-item dropdown menu-large"><a href="category-full.php?accessories" data-toggle="dropdown" data-hover="dropdown" data-delay="200" class="dropdown-toggle nav-link ml-lg-4">Accessories<b class="caret"></b></a>
                <ul class="dropdown-menu megamenu">
                  <li>
                    <div class="row">
                      <div class="col-md-6 col-lg-3">
            ...
            <div class="navbar-buttons d-flex justify-content-end">
              ...
              <?php if(isset($_SESSION['uid'])) {  ?>
              <div id="basket-overview" class="navbar-collapse collapse d-none d-lg-block"><a href="basket.php" class="btn btn-primary navbar-btn"><i class="fa fa-shopping-cart"></i><span id="totalCart"><?= $totalCart ?> items in cart</span></a></div>
               <?php } else { ?>
      ...
      <div id="search" class="collapse">
        <div class="container">
          <form role="search" class="ml-auto" method="get" action="search.php" name="srch">
            <div class="input-group">
              <input type="text" placeholder="Search" class="form-control" name="search" id="srch" onBlur="disppearSrch()">
              <div class="input-group-append">
                <button type="submit"  class="btn btn-primary" onclick="return(submitreg2());"><i class="fa fa-search"></i></button>
              </div>
